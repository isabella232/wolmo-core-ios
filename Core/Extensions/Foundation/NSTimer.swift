...
public extension Timer {
     ...
     */
    public static func schedule(_ delay: TimeInterval, handler: @escaping (Timer!) -> Void) -> Timer {
    ...
    /**
     ...
     - returns: The newly-created `NSTimer` instance.
     */
    public static func schedule(repeatInterval interval: TimeInterval, handler: @escaping (Timer!) -> Void) -> Timer {
