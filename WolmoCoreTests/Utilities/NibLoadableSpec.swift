...
public class NibLoadableSpec: QuickSpec {
    ...
    private func loadCustomTableNib() -> NibLoadableTableViewCustom? {
        return NibLoadableTableViewCustom.loadFromNib()
    }
    
    private func loadStructNib() -> NibLoadableStruct? {
        return NibLoadableStruct.loadFromNib()
    }
}
